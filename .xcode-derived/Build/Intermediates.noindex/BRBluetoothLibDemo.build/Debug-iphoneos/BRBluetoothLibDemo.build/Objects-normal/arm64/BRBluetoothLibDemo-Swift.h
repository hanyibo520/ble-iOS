...
#ifndef BRBLUETOOTHLIBDEMO_SWIFT_H
#define BRBLUETOOTHLIBDEMO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BRBluetoothLibDemo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18BRBluetoothLibDemo21BRDemoBluetoothBridge")
@interface BRDemoBluetoothBridge : NSObject
...
@interface BRDemoBluetoothBridge (SWIFT_EXTENSION(BRBluetoothLibDemo)) <CBPeripheralDelegate>
...
@class NSString;
@class NSNumber;
@interface BRDemoBluetoothBridge (SWIFT_EXTENSION(BRBluetoothLibDemo)) <CBCentralManagerDelegate>
